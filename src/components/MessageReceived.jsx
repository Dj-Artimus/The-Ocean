...
const MessageReceived = ({ content, images, videos, created_at, isRead }) => {
  return (
    <div className="w-full">
      <div className=" bg=background shadow-sm shadow-rose-500 dark:shadow-blue-500 dark:bg-d_foreground max-w-[70%] p-2 px-3 float-start mb-3 rounded-xl rounded-tl-none ">
