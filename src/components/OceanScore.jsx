...
const OceanScore = ({anchors, anchorings}) => {
  return (
    <div className="flex w-full max-w-80 items-center shadow-sm shadow-blue-500 rounded-xl bg-foreground dark:bg-d_foreground p-1">
      <div className="xs1:flex flex-col items-center p-2 rounded-xl text-blue-500 font-semibold hidden cursor-pointer hover:bg-primary dark:hover:bg-d_primary w-full hover:text-blue-400">
        <AnchorIcon />
