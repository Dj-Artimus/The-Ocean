...
export const config = {
  matcher: [
    ...
    '/((?!_next/static|_next/image|favicon.ico|login|signup|forgot-password|landing-page|verify-email|reset-password|auth/callback|droplet/[^/]+|.*\.(?:svg|png|jpg|jpeg|gif|webp)).*)',
  ],
};
